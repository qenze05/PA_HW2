...
public class Main {
    ...
    public static void simulateGame() {
        ...
        saveGameResults(server, "${artifactId}/src/main/resources/${artifactId}.json");
    }

    public static void saveGameResults(GameServer ${artifactId}Server, String filePath) {
        Gson gson = new GsonBuilder().setPrettyPrinting().create();

        String jsonString = gson.toJson(${artifactId}Server);
